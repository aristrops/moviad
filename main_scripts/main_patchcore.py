...
def train_patchcore(dataset_path: str, categories: str, backbone: str, ad_layers: list, compress_images,
    ...
    for category in categories:
        ...
        patchcore = PatchCore(device, input_size=(224, 224), feature_extractor=feature_extractor,
                              compression_method=feature_compression_method)
        patchcore.to(device)
        patchcore.train()
...
def test_patchcore(dataset_path: str, categories: str, backbone: str, ad_layers: list, model_checkpoint_path, compress_images,
...
def main():
    ...
    parser.add_argument("--scenario", type=str, help="Which scenario to run the train on")
    ...
    if args.mode == "train":
        train_patchcore(args.scenario, args.dataset_path, args.categories, args.backbone, args.ad_layers,
                        ...
                        args.save_path, device)
    elif args.mode == "test":
        test_patchcore(args.dataset_path, args.categories, args.backbone, args.ad_layers, args.save_path, args.compress_images,
                       args.quality, args.image_compression_method,  args.visual_test_path, args.feature_compression_method,
                       args.sampling_ratio, args.pq_method, args.pq_subspaces, device)
