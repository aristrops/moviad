...
def train_fastflow(dataset_type: str, backbone: str, save_path: str, device: torch.device, epochs: int = 100):
...
def main():
    ...
    if args.mode == "train":
        train_fastflow(args.dataset_type, args.backbone, args.save_path, device, args.epochs)
