...
from moviad.dinomaly.dinov1 import vision_transformer
from moviad.dinomaly.dinov2.models import vision_transformer as vision_transformer_dinov2
from moviad.dinomaly.beit.vision_transformer import beitv2_base_patch16_448,beitv2_base_patch16_224
import numpy as np
...
def load(name):
    ...
    if "deit" in name:
        if arch == "base":
            ...
            ckpt_pth = download_cached_file(
                f"https://dl.fbaipublicfiles.com/deit/deit_tiny_patch16_224-a1311bcf.pth")
        else:
            raise ValueError("Invalid type of architecture. It must be either 'small', 'base' or 'tiny'.")
