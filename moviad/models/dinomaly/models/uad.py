...
class ViTill(nn.Module):
    ...
    def forward(self, x):
        if self.compression_method is not None:
            ...
            #         en_list.append(x)
            en_list = self.extract_features(x)
        ...
        # print(f"en_list length: {len(en_list)}")
        # print(f"fuse_layer_encoder: {self.fuse_layer_encoder}")
        # print(f"fuse_layer_decoder: {self.fuse_layer_decoder}")
