...
def main(args):
    ...
    student_bootstrap_layer = args.student_bootstrap_layer  
    ...
    for seed in seeds:
        ...
        for category_name in categories:
            ...
            print("---- STFPM Profiler ----")

            # load the model if it was not trained in this run
            stfpm = Stfpm(ad_layers=ad_layers_idxs,
                          backbone_model_name=backbone_model_name,
                          student_bootstrap_layer=student_bootstrap_layer,
                        )
            stfpm.load_state_dict(torch.load(save_path, map_location=device), strict=False)
            stfpm.to(device)
